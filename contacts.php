				...
				<form id="editContact" action="#" method="post">
						  ...
						  <div class="row">
							<div class="large-6 columns">
							 ...
							 <div class="large-6 columns">
							  <label>nights
								<input name="nights" type="text" placeholder="Enter nombre de nuits" value="<?php echo $contact->nights; ?>" />
							  </label>
							</div>
						  </div>
						  <div class="row">
							...
							<div class="large-4 columns">
								<label>Zipcode
								<input name="zipcode" type="text" placeholder="Enter code postale" value="<?php echo $contact->zipcode; ?>" />
							  </label>
							</div>
						  </div>
						  <div class="row">
